...
public class panelVolumen {
    ...
    public void initComponents (JPanel p) {
        ...
        String[] cboxItems = {"Galón (gal)","Metro cúbico","Litro (l)","Onza líquida (oz)","Centímetro cúbico","Milímetro cúbico"};
        ...
        bconvert.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (boxAmount.getText().equals("")) {
                    ...
                    try {
                        volumenConverter conversor = new volumenConverter();
