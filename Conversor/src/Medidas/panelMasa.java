...
public class panelMasa {
    ...
    public void initComponents (JPanel p) {
        ...
        String[] cboxItems = {"Kilogramo (kg)","Libra (lb)","Tonelada (t)","Miligramo (mg)","Nanogramo (ng)","Gramos (g)"};
        ...
        bconvert.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (boxAmount.getText().equals("")) {
                    ...
                    try {
                        masaConverter conversor = new masaConverter();
