...
public class panelLongitud {
    ...
    public void initComponents (JPanel p) {
        ...
        String[] cboxItems = {"Kilómetro (km)","Metro (m)","Centímetro (cm)","Milímetro (mm)","Pie (ft)","Pulgada (in)","Milla"};
        ...
        bconvert.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (boxAmount.getText().equals("")) {
                    ...
                    try {
                        longitudConverter conversor = new longitudConverter();
