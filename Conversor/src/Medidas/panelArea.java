...
public class panelArea {
    ...
    public void initComponents (JPanel p) {
        ...
        String[] cboxItems = {"Metro cuadrado","Kilometro cuadrado","Milla cuadrada","Yarda cuadrada","Pie cuadrado","Pulgada cuadrada","Hectarea"};
        ...
        //txtfield
        txtamount.setBounds(132,0,50,25);
        ...
        bconvert.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (boxAmount.getText().equals("")) {
                    ...
                    try {
                        areaConverter conversor = new areaConverter();
